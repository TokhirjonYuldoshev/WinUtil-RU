function Set-WinUtilTweaksProgressIndicator {
    ...
    if ($PSBoundParameters.ContainsKey('Label') -and
        (Get-Command Convert-WinUtilRussianText -ErrorAction SilentlyContinue)) {
        $indicatorLabel = Convert-WinUtilRussianText $Label
    }
