...
If Microsoft Defender Antivirus is not running, the Telemetry tweak skips its sample submission setting and reports a warning. Its other actions continue; check Windows Security to see which antivirus protects the device.
